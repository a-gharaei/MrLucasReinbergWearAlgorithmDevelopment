...
class Grain3D:
    ...
    def update_mesh(self, mesh):
        ...
        self.minx = mesh.bounds[0][0]
        self.miny = mesh.bounds[0][1]
        self.minz = mesh.bounds[0][2]
        self.maxx = mesh.bounds[1][0]
        self.maxy = mesh.bounds[1][1]
        self.maxz = mesh.bounds[1][2]
