...
def tutorial_run(use_reduced_grain):
    ...
    box = Box.from_sizes(size_x=10, size_y=5, size_z=5, pose=Pose.identity())
    ...
    for current_tool_pose in kin.ToolTrajectory.poses:
        ...
        apply_attritious_wear(
            wear_model_result, tool, mat_remover_result, use_reduced_grain
        )
        ...
        # apply fracture wear #! Not finished
        (
        ...
        # bond_wear_model_result = apply_archard_bonding_wear_model(
        #     tool, 1, 1, grain_force_model_result
        # )
    ...
    # save to disk
    path = r"./SimulationResults/MyFancySimulation"
